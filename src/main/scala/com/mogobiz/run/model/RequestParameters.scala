...
object RequestParameters {
  ...
  case class PromotionRequest(override val maxItemPerPage: Option[Int], override val pageOffset: Option[Int], orderBy: Option[String], orderDirection: Option[String], categoryPath: Option[String], lang: String) extends PagingParams

  case class FacetRequest(
      priceInterval: Long, productId: Option[String], xtype: Option[String], name: Option[String], code: Option[String], rootCategoryPath: Option[String], categoryPath: Option[String], brandId: Option[String], tags: Option[String], notations: Option[String], priceRange: Option[String], creationDateMin: Option[String], featured: Option[Boolean], lang: String, country: Option[String], promotionId: Option[String], hasPromotion: Option[Boolean], inStockOnly: Option[Boolean], property: Option[String], features: Option[String], variations: Option[String], brandName: Option[String], categoryName: Option[String], multiCategory: Option[Boolean], multiBrand: Option[Boolean], multiTag: Option[Boolean], multiFeatures: Option[Boolean], multiVariations: Option[Boolean], multiNotation: Option[Boolean], multiPrices: Option[Boolean]) {
    def this(priceInterval: Long, lang: String) = this(priceInterval, None, None, None, None, None, None, None, None, None, None, None, None, lang, None, None, None, Some(true), None, None, None, None, None, None, None, None, None, None, None, None)
  }

  //--- Products

  case class ProductRequest(
      override val maxItemPerPage: Option[Int], override val pageOffset: Option[Int], id: Option[String], xtype: Option[String], name: Option[String], fullText: Option[String], code: Option[String], categoryPath: Option[String], brandId: Option[String], tagName: Option[String], notations: Option[String], priceRange: Option[String], creationDateMin: Option[String], featured: Option[Boolean], orderBy: Option[String], orderDirection: Option[String], lang: String, currencyCode: Option[String], countryCode: Option[String], promotionId: Option[String], hasPromotion: Option[Boolean], inStockOnly: Option[Boolean], property: Option[String], feature: Option[String], variations: Option[String]) extends PagingParams {
  ...
  case class SkuRequest(
      override val maxItemPerPage: Option[Int], override val pageOffset: Option[Int], id: Option[String], productId: Option[String], xtype: Option[String], name: Option[String], code: Option[String], categoryPath: Option[String], brandId: Option[String], tagName: Option[String], notations: Option[String], priceRange: Option[String], creationDateMin: Option[String], featured: Option[Boolean], orderBy: Option[String], orderDirection: Option[String], lang: String, currencyCode: Option[String], countryCode: Option[String], promotionId: Option[String], hasPromotion: Option[Boolean], inStockOnly: Option[Boolean], property: Option[String], feature: Option[String], variations: Option[String]) extends PagingParams {
    def this(lang: String, currencyCode: String, countryCode: String) = this(None, None, None, None, None, None, None, None, None, None, None, None, None, Some(false), None, None, lang, None, None, None, Some(false), Some(true), None, None, None)
  }
