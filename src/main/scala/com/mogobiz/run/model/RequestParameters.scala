...
object RequestParameters {
  ...
  case class FacetRequest(
      priceInterval: Long, productId: Option[String], xtype: Option[String], name: Option[String], code: Option[String], categoryPath: Option[String], brandId: Option[String], tags: Option[String], notations: Option[String], priceRange: Option[String], creationDateMin: Option[String], featured: Option[Boolean], lang: String, country: Option[String], promotionId: Option[String], hasPromotion: Option[Boolean], inStockOnly: Option[Boolean], property: Option[String], features: Option[String], variations: Option[String], brandName: Option[String], categoryName: Option[String], multiCategory: Option[Boolean], multiBrand: Option[Boolean], multiTag: Option[Boolean], multiFeatures: Option[Boolean], multiVariations: Option[Boolean], multiNotation: Option[Boolean], multiPrices: Option[Boolean]) {
