...
object ES {
  ...
  case class BOCartEx(transactionUuid: Option[String],
    buyer: String,
    @JsonSerialize(using = classOf[JodaDateTimeSerializer])@JsonDeserialize(using = classOf[JodaDateTimeDeserializer]) xdate: DateTime,
    price: Long,
  ...
  case class BODelivery(@JsonScalaEnumeration(classOf[DeliveryStatusRef]) status: DeliveryStatus,
  ...
  case class BORegisteredCartItem(age: Int,
    ...
    email: Option[String],
    phone: Option[String],
    @JsonSerialize(using = classOf[JodaDateTimeOptionSerializer])@JsonDeserialize(using = classOf[JodaDateTimeOptionDeserializer]) birthdate: Option[DateTime],
