...
object Mogobiz {
  ...
  @JsonIgnoreProperties(ignoreUnknown = true)
  case class Poi(description: String, name: String, picture: String, xtype: String, location: Location)

  @JsonIgnoreProperties(ignoreUnknown = true)
  case class LocalTaxRate(id: Long, rate: Float, countryCode: String, stateCode: String)
  ...
  @JsonIgnoreProperties(ignoreUnknown = true)
  case class DatePeriod(@JsonSerialize(using = classOf[JodaDateTimeSerializer]) @JsonDeserialize(
                        ...
                        @JsonSerialize(using = classOf[JodaDateTimeSerializer]) @JsonDeserialize(
                            using = classOf[JodaDateTimeDeserializer]) endDate: DateTime)
  ...
  case class Sku(id: Long,
                 ...
                 @JsonSerialize(using = classOf[JodaDateTimeOptionSerializer]) @JsonDeserialize(
                     using = classOf[JodaDateTimeOptionDeserializer]) availabilityDate: Option[DateTime] = None,
                 @JsonSerialize(using = classOf[JodaDateTimeOptionSerializer]) @JsonDeserialize(
                     using = classOf[JodaDateTimeOptionDeserializer]) startDate: Option[DateTime] = None,
                 @JsonSerialize(using = classOf[JodaDateTimeOptionSerializer]) @JsonDeserialize(
                     using = classOf[JodaDateTimeOptionDeserializer]) stopDate: Option[DateTime] = None,
  ...
  @JsonIgnoreProperties(ignoreUnknown = true)
  case class Category(id: Long, parentId: Option[Long], path: String, name: String, uuid: String)
