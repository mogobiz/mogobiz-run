...
object CartBoService {
   ...
   */
  def addItem(locale:Locale , currencyCode:String , cartVO:CartVO , ticketType:TicketType , quantity:Int, dateTime:Option[DateTime], registeredCartItems:List[RegisteredCartItemVO]):CartVO  = {
    // init local vars
