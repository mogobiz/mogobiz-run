 ...
 */
case class Product(
                    code:String,name:String,xtype:String,price:Long
/*plus tard
...
case class ProductRequest(
                           ...
                           ,pageOffset:Option[Int],xtype:Option[String]
                           ,name:Option[String],code:Option[String]
                           ,categoryId:Option[Int],brandId:Option[Int]
                           ,tagName:Option[String],priceMin:Option[Long]
                           ,priceMax:Option[Long],creationDateMin:Option[String]
                           ,orderBy:Option[String],orderDirection:Option[String]
                           ,lang:String,storeCode:String,currencyCode:String
                           ,countryCode:String)
